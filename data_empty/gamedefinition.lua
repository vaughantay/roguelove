gamesettings = {
  ...
  spells_forgettable_by_default=true, --If true, spells can be "forgotten" from the spell screen, unless the spells forgettable flag is explicitly set to false. If not set to true, spells can be forgotten if their forgettable flag is true
  ...
  always_use_color_with_tiles=false
}