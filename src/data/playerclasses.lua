playerClasses = {
  alchemist = {
    ...
    skills={melee=2,ranged=6,magic=3,alchemy=10}, --The skills that this character will start with (in addition to default skills)
    ...
    stat_modifiers={toughness=1,max_mp=20}, --These values will be added to the characters' base stats
  ...
  holywarrior = {
    ...
    skills={melee=5,ranged=5,theology=5}, --The skills that this character will start with (in addition to default skills)
    ...
    stat_modifiers={strength=2,agility=2,toughness=2,max_mp=10}, --These values will be added to the characters' base stats
    money=100, --Amount of money the character starts with
  ...
  beefcake = {
    ...
    skills={ranged=2,melee=7}, --The skills that this character will start with (in addition to default skills)
    ...
    spell_choices={}, --These spells will show up as options when you reach their level, and you can choose one of them
    stat_modifiers={strength=10,max_hp=25,toughness=3,armor=1}, --These values will be added to the characters' base stats
    stats_per_level={strength=1}, --Stat increase per level
    money=100, --Amount of money the character starts with
  ...
  barbarian = {
    ...
    skills={melee=10}, --The skills that this character will start with (in addition to default skills)
    ...
    stat_modifiers={strength=10,max_hp=25,toughness=5,armor=2}, --These values will be added to the characters' base stats
    stats_per_level={strength=2}, --Stat increase per level
  ...
  demonologist = {
    ...
    skills={melee=5,ranged=5,magic=5,demonology=5}, --The skills that this character will start with (in addition to default skills)
    ...
    stat_modifiers={agility=1,toughness=1,max_mp=15}, --These values will be added to the characters' base stats
    money=100 --Amount of money the character starts with
  },
  wimp = {
    name="Total Wimp",
    ...
    skills={ranged=5,magic=5,melee=false,strength=false}, --The skills that this character will start with (in addition to default skills)
    stat_modifiers={max_hp=-25,max_mp=5,toughness=-2,strength=-5}, --These values will be added to the characters' base stats
  ...
  pyromancer = {
    ...
    skills={melee=3,ranged=5,magic=10}, --The skills that this character will start with (in addition to default skills)
    ...
    spell_purchases={}, --These spells will show up as options to learn (requiring spending points on them)
    spell_choices={}, --These spells will show up as options when you reach their level, and you can choose one of them
    stat_modifiers={strength=-1,agility=1,toughness=1,max_mp=25}, --These values will be added to the characters' base stats
  ...
  necromancer = {
    ...
    skills={ranged=2,magic=15}, --The skills that this character will start with (in addition to default skills)
    ...
    spell_purchases={}, --These spells will show up as options to learn (requiring spending points on them)
    spell_choices={}, --These spells will show up as options when you reach their level, and you can choose one of them
    stat_modifiers={strength=-2,toughness=-1,agility=1,max_mp=30}, --These values will be added to the characters' base stats
  }
}